...
<div class="p-4">
    <h2 class="text-4xl font-bold border-b-4 border-blue-400">Categories</h2>
    <div class="my-5 text-right">
        <a href="{{route('category.create')}}" class="bg-blue-600 text-white px-3 py-2 rounded-lg">Add Category</a>
    </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$category->name}}</td>
            <td>
                <a href="{{route('category.edit',$category->id)}}" class="bg-blue-600 text-white rounded-lg px-3 py-1 mx-1">Edit</a>
                <a onclick="showDelete('{{$category->id}}')" class="bg-red-600 text-white rounded-lg px-3 py-1 mx-1">Delete</a>
            </td>
        </tr>
        @endforeach
    </tbody>
