...
<div class="p-4">
    <h2 class="text-4xl font-bold border-b-4 border-blue-400">Galleries</h2>
    <div class="my-5 text-right">
        <a href="{{route('gallery.create')}}" class="bg-blue-600 text-white px-3 py-2 rounded-lg">Add Gallery</a>
    </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a onclick="showDelete('{{$gallery->id}}')" class="bg-red-600 text-white rounded-lg px-3 py-1 mx-1">Delete</a>
            </td>
        </tr>
        @endforeach
    </tbody>
