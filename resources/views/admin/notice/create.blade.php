...
<div class="p-4">
    ...
    <form action="{{route('notice.store')}}" method="POST" class="mt-5">
        ...
        <input type="text" name="notice" class="w-full rounded-lg mt-2" placeholder="Enter Notice Name" value="{{old('notice')}}">
        @error('notice')
        ...
        <div class="mt-5 flex">
            <input type="submit" value="Add Notice" class="bg-blue-600 text-white px-4 py-2 rounded-lg cursor-pointer mx-2">
